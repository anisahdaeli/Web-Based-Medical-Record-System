   <div class="content-wrapper">
    ...
    <section class="content-header">
      <br>
      <h1 class='text-success'>Halaman Tambah Data Pembayaran<hr></h1>
    </section>
   <!-- Main content -->
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <form action="<?= base_url('index.php/adminpembayaran/tambah_aksi'); ?>" method="post">
              ...
              <table id="example2" class="table table-bordered table-hover ">
                  ...
                  <tr >
                    <td colspan="2" style="font-weight: bold; text-align: center; ">Subtotal</td>
                     <td style="text-align: right;"><?= "Rp. ".number_format((float)$subtotal,0,',','.') ?></td>
                    <td>
                    </td>
                  </tr>
                  <tr>  
                  ...
                  <tr>  
                    ...
                    <td><center>
                        ...
                        <a class="btn btn-warning" href="<?= base_url().'index.php/adminpembayaran/hapus_detail_bayar/'.$kodebayar;?>">Batal</a>
                      </center>
...
<script type="text/javascript" src="<?php echo base_url().'assets/js/jquery-3.3.1.js'?>"></script>
  ...
  $(document).ready(function(){
    $('#id_tarif').change(function() {
      ...
      $.ajax({
        type : 'POST',
        url : '<?= base_url('index.php/adminpembayaran/cek_tarif') ?>',
        Cache : false,
        dataType: "json",
        data : 'id_tarif='+id,
 ...
 <script type="text/javascript">
  $(document).ready(function(){
    $('#kd_resep').change(function() {
      ...
      $.ajax({
        type : 'POST',
        url : '<?= base_url('index.php/adminpembayaran/cek_harga') ?>',
        Cache : false,
        dataType: "json",
        data : 'kd_resep='+id,
        success : function(resp) {
