  <div class="content-wrapper">
    ...
    <section class="content-header">
      <br>
      <h1 class='text-success'>Halaman Detail Data Pembayaran<hr></h1>
    </section>
            <!-- Main content -->
...
<div class="box-body">            
           <table id="example1" class="table table-bordered table-striped ">
                      <thead>
                        ...
                        <td><a class="btn btn-default" href="<?= base_url('index.php/adminpembayaran/cetak_bayar/').$r->kd_bayar ?>"><i class="fa fa-print"></i>Cetak</a>
                          <a class="btn btn-danger" href="<?= base_url('index.php/adminpembayaran/hapus/').$r->kd_bayar ?>"><i class="fa fa-trash"></i>Hapus</a>
                        </td>
                          </tr>
                        <?php } ?>
                       </tbody>
