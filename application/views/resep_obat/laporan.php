                ...
                <form method="get" action="" class="form">
                  ...
                  <div class="form-group" id="form-kd_rm">
                    ...
                    <select name="kd_rm" class="form-control select2" style="width: 50%">
                      <option value="">Pilih</option>
                      <?php
                        foreach($resep_obat as $data){ // Ambil data tahun dari model yang dikirim dari controller
                  ...
                  <button class="btn btn-primary" type="submit">Tampilkan</button>
                    <a href="<?php echo base_url()."index.php/dokterresepobat/laporan"; ?>" class="btn btn-warning">Reset Filter</a>
                </form>
              ...
              <?php
                ...
                ?>    
                  <tr>
                   ...
                   <td><?php echo date('d-m-Y', strtotime($data['tanggal_resep'])); ?></td>
                ...
                <script src="<?php echo base_url('resources/js/jquery-ui.min.js'); ?>"></script> <!-- Load file plugin js jquery-ui -->
                <script>
