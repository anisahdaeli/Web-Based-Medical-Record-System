        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <form action="<?= base_url('index.php/dokterresepobat/tambah_aksi'); ?>" method="post">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="pengobatan" name="pengobatan" value="<?= $u->pengobatan ?>" readonly>
                </div>
                ...
                <select class="form-control select2"  id="id_obat" name="id_obat">
                  <option selected="selected" value="">Pilih Obat</option>
                        <?php foreach ($obat as $r) : ?>
                         <option data-harga="<?= $r->harga ?>" data-stok="<?= $r->stok ?>" value="<?= $r->id_obat ?>"><?= $r->nama_obat ?></option>
                       <?php endforeach; ?>
                            </select>
            </div>
          ...
          <label for="stok_out" class="col-sm-1 col-form-label">Stok Keluar </label>
            ...
            <input type="number" class="form-control" name="stok_out">         
                ...
                <div class="col-sm-3">
                <select class="form-control select2" id="aturan_pakai" name="aturan_pakai[]">
                  <option selected="selected" value=" ">Aturan Pakai</option>
          ...
          <div class="box-body">            
           <table id="example2" class="table table-bordered table-striped ">
                    ...
                    <?php 
                     ...
                     <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('index.php/dokterresepobat/hapus/'.$r->id_detail) ?>" class="btn btn-danger btn-xs float-right">Hapus</a>  
                  ...
                  <tr>
                    ...
                    <td><?= "Rp. ".number_format((float)$subtotal)." ,-" ?></td>
                    <td><center>
                         <div class="box-footer">
                      
                        <a class="btn btn-warning" href="<?= base_url('index.php/dokterresepobat/cetak_resep/').$koderesep ?>"><i class="fa fa-print"></i>Cetak</a>
                        <a class="btn btn-primary" href="<?= base_url().'index.php/dokterresepobat/hapus_detail_resep/'.$koderesep ?>">Batal</a>
                      </div>
...
<script type="text/javascript">
  ...
  const harga = $('#id_obat option:selected').data('harga');
  const stok = $('#id_obat option:selected').data('stok');
