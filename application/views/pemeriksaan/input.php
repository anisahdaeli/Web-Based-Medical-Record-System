            ...
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <form action="<?= base_url('index.php/dokterpemeriksaan/tambah_aksi'); ?>" method="post">
...
<div class="box-footer">
           ...
           <div class="box-header">
              <h3 class=" text-success box-title">Data Pemeriksaan</h3>
            </div>
           <div class="box-body">
                    ...
                    <?php 
                     ...
                     <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('index.php/dokterpemeriksaan/hapus/'.$r->id_periksa) ?>" class="btn btn-danger float-right" onclick="return confirm('yakin dok, mau dihapus?');">Hapus</a>
                        <a class="btn btn-default" href="<?= base_url('index.php/dokterpemeriksaan/cetak_pemeriksaan/').$r->id_periksa ?>"><i class="fa fa-print"></i>Cetak</a>  
